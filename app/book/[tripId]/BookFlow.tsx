...
import { formatDuration, formatMoney, formatTime, formatDate } from "@/lib/utils";
            ...
            {data.fares.map((f) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1 text-lg font-bold text-title">{formatMoney(f.price)}</p>
      ...
      <aside className="mt-6 lg:mt-0">
        <Card className="sticky top-20 p-4">
          ...
          <div className="mt-3 space-y-2 text-sm">
            <Row label={`${fare?.label ?? "Fare"} × ${paxCount}`} value={formatMoney((fare?.price ?? 0) * paxCount)} />
